# Co-SLAM Project Overview and Setup
...
- [x] Tutorials on params & creating sequences using iPhone/iPad Pro [click here](./CoSLAM_Dataset_and_Parameter_Guide.md).   [2023-5-26]
