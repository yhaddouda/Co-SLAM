...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_json", type=str, 
                        default="", help="Path to write metrics JSON")
    parser.add_argument("--run_tag", type=str,
                        default="", help="Optional tag for this run")

    args = parser.parse_args()

    results = {}
    if args.metric_3d:
        results["3d"] = calc_3d_metric(args.rec_mesh, args.gt_mesh)
