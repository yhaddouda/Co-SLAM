# Run
python coslam.py --config "./configs/Synthetic/wr.yaml"
...
# cull the mesh
INPUT_MESH=output/Synthetic/wr/19_base/mesh_track1675.ply
VIRT_CAM_PATH=../datasets/vv_data/neural_rgbd_data/whiteroom/virtual_cameras/
python neural_slam_eval/cull_mesh.py --config configs/Synthetic/wr.yaml --input_mesh $INPUT_MESH --remove_occlusion --virtual_cameras --virt_cam_path $VIRT_CAM_PATH --gt_pose 
